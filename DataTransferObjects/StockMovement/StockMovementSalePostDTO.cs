...
namespace DataTransferObjects.StockMovement
{
    public class StockMovementSalePostDTO
    {
        ...
        public StockMovementSalePostDTO(int idUser)
        {
            UserId = idUser;
        }

        public StockMovementSalePostDTO() { }
    }
}
